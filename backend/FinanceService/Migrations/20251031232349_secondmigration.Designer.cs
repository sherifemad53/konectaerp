...
namespace FinanceService.Migrations
{
    ...
    [Migration("20251031232349_secondmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceService.Models.EmployeeBonus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EmployeeCompensationAccountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmployeeCompensationAccountId");

                    b.ToTable("EmployeeBonuses");
                });

            modelBuilder.Entity("FinanceService.Models.EmployeeCompensationAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EmployeeCompensationAccounts");
                });

            modelBuilder.Entity("FinanceService.Models.EmployeeDeduction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinanceService.Models.EmployeeBonus", b =>
                {
                    b.HasOne("FinanceService.Models.EmployeeCompensationAccount", "Account")
                        .WithMany("Bonuses")
                        .HasForeignKey("EmployeeCompensationAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
